...
WQ=np.mat([[(delta*(WR**2)+delta*(WL**2))*((T*R*math.cos(angstate1)/float(2)))**2), ((T*R/float(2))**2)*math.sin(angstate1)*math.cos(angstate1)*(delta*(WR**2)+delta*(WL**2)), ((T*R)**2)*math.cos(angstate1)*(delta*(WR**2)-delta*(WL**2))/float(2*L)],[((T*R/float(2))**2)*math.sin(angstate1)*math.cos(angstate1)*(delta*(WR**2)+delta*(WL**2)),(delta*(WR**2)+delta*(WL**2))*((T*R*math.sin(angstate1)/float(2)))**2), ((T*R)**2)*math.sin(angstate1)*(delta*(WR**2)-delta*(WL**2))/float(2*L)],[((T*R)**2)*math.cos(angstate1)*(delta*(WR**2)-delta*(WL**2))/float(2*L), ((T*R)**2)*math.sin(angstate1)*(delta*(WR**2)-delta*(WL**2))/float(2*L),(delta*(WR**2)+delta*(WL**2))*(((T*R/float(L))**2)]])
