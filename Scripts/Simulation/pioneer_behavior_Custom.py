...
# To auto operate and call commands from Linux Shell
...
class PioneerSimpleBehavior(object):
    ...
    def laser_callback(self, msg):
        ...
        ##              Ruben -> Debugging                   ##
        #print (msg)
        #print ("temos " ,len(msg.ranges), " valores de range")
...
# class BuildSystem (object):           #Not Implemented : in a near future
# """This class will run all necessaries programs to use ROS and the robot"""
#     def __init__(self):
#         self.car = 0
#
#     def infra(self):
